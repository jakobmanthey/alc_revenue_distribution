...
evs[, grep("wein|bier|sprit", names(evs))] <- sapply(evs[, grep("wein|bier|sprit|misch", names(evs))], as.numeric)
...
``` {r test}
avg_beer_price_smallbottle <- mean(evs$bier_untergärig_wert[evs$bier_untergärig_menge %% 0.33 == 0] / evs$bier_untergärig_menge[evs$bier_untergärig_menge %% 0.33 == 0], na.rm = T)*0.33
print(avg_beer_price_smallbottle)
```
...
- Standard Drinks präzisieren
- Mischgetränke inkludieren
- Konfidenzintervalle basierend auf n Haushalte statt n Personen
