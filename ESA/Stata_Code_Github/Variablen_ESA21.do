...
* Erst 2021 aufbereiten und auf nötige Variablen reduzieren und dann 2018 und dann appenden
...
* Keine Ausbesserung durch einzelne Getränkesorten, weil Inkonsistente Angaben in alk30gr kontrolliert
gen trinkgruppe=.
...
replace hne3_21 = 1 if hne == 1 | hne == 2 | hne == 3 | hne == 4 | hne == 5 | hne == 6 | hne == 7 | hne == 8 | hne==9
replace hne3_21 = 2 if hne == 10 | hne == 11 
replace hne3_21 = 3 if hne == 12 | hne == 13
...
label values hne3_21 einkommensgruppen

label var hne3_21 "Haushaltsnetto-Einkommensgruppen"
...
* Gewichte ermitteln, anhand f11_1 und f11_2
* 2018 Haushaltsgröße über 20 auf Missing gesetzt, daher hier auch
fre f11_1
replace f11_1=.f if f11_1>20 & f11_1<.

* Jetzt erstmal das Gewicht von 1 für Ein-Personen-Haushalte definieren
gen gewicht_hne= 1 if f11_1==1 // f11_2 umcodiert auf Missing für Personen im Ein Personen Haushalt

* Weitere Personen über 14 +0.5 (-1 da man den Befragten noch abziehen muss)
gen help_adultshh=(f11_1-f11_2)-1

******* Annahme: ***********************
* wenn -1, sich selber vergessen, daher 0 Erwachsene
list alter f11_1 f11_2 help_adultshh if help_adultshh<0
replace help_adultshh=0 if help_adultshh==-1
* Unzuverlässige Angaben, wenn Differenz kleiner als -1
replace help_adultshh=. if help_adultshh<-1 

* Weitere Personen unter 14 +0.3
gen help_childhh=f11_2
fre f11_1 if f11_2==.b // erlaubter Sprung auch für Missings in f11_1 (n=12)
* Für Korrektur nur Ein-Personen-Haushalte nehmen
* Sollte keinen Unterschied machen, da diese eh nicht korrigiert werden
replace help_childhh=0 if f11_1==1 // Auf Null setzen für Ein-Personen-Haushalte
* Alle mehr als Ein-Personenhaushalte mit gewichteter Haushaltsgröße erhöhen (1+ da vorher abgezogen)
replace gewicht_hne=1+0.5*help_adultshh+0.3*help_childhh if gewicht_hne!=1
sum gewicht_hne
...
replace hne_mean=1379/gewicht_hne if hne==5 & gewicht_hne>1 & gewicht_hne<=1.5 // 1250- unter 1500 
replace hne_mean=1365/gewicht_hne if hne==5 & gewicht_hne>1.5 & gewicht_hne<. // 1250- unter 1500 
replace hne_mean=1624/gewicht_hne if hne==6 & gewicht_hne==1 // 1500- unter 1750
replace hne_mean=1623/gewicht_hne if hne==6 & gewicht_hne>1 & gewicht_hne<=1.5 // 1500- unter 1750
replace hne_mean=1619/gewicht_hne if hne==6 & gewicht_hne>1.5 & gewicht_hne<. // 1500- unter 1750 
...
label var hne_mean "Netto-Äquivalenzeinkommen (Mean EVS 2021)"

egen hne_eq3_21=xtile(hne_mean), n(3) 
 
label values hne_eq3_21 einkommensgruppen

tab hne_eq3_21 hne3_21, m
list hne hne_eq f11_1 f11_2 if hne3_21==3 & hne_eq3_21==1 // Haushaltsgröße auf unter 20 beschränkt
tab hne hne_eq3_21, m  
bysort hne_eq3_21: sum hne_eq // Grenzen Äuivalenzeinkommen: 1 bis 1583€ 2 bis 2500€ 3 ab 2586€
tab hne hne3_21, m // Grenzen Hauhshaltseinkommen: 1 bis 2500€ 2 bis unter 4000€ 3 ab 4000€
tab hne hne_eq3_21, m 

***** EXTERNE Threasholds anhand EU-SILC
* 2021 1. Quartil 1475 2. Quartil 2079 3 Quartil 2924 4. Quartil >2924
* /max bis höchsten Wert (exkl. Missings!)
recode hne_mean (0/1475 = 1 "Niedriges Einkommen (1. Quartil)") ///
(1475/2924 = 2 "Mittleres Einkommen (2. + 3. Quartil)") ///
(2924/max = 3 "Hohes Einkommen (4. Quartil)"), gen(hne_eq4_21)

tab hne hne_eq4_21, m
tab hne_eq4_21 hne3_21, m
tab hne_eq4_21 hne_eq3_21, m

***** EXTERNE Threasholds anhand EU-SILC
* 2021 1.-3. Dezil 1590 4.-7. Dezil 2712 8. - 10. Dezil >2712
* /max bis höchsten Wert (exkl. Missings!)
recode hne_mean (0/1590 = 1 "Niedriges Einkommen (1.-3. Dezil)") ///
(1590/2712 = 2 "Mittleres Einkommen (4.-7. Dezil)") ///
(2712/max = 3 "Hohes Einkommen (8.-10. Dezil)"), gen(hne_eq10_21)

tab hne hne_eq10_21, m
tab hne_eq10_21 hne3_21, m
tab hne_eq10_21 hne_eq3_21, m

*******************************************************************************
* Gruppen für Auswertung (18 Gruppen)

fre ges2 hne_eq4_21 hne_eq3_21 hne_eq10_21 altgr3

egen group1_21 = group(ges2 hne_eq4_21 altgr3)
egen group2_21 = group(ges2 hne_eq3_21 altgr3)
egen group3_21 = group(ges2 hne_eq10_21 altgr3)
...
label values group1_21 group2_21 group3_21 group_labels

label var group1_21 "Gruppen: Einkommen nach hne_eq4_21"
label var group2_21 "Gruppen: Einkommen nach hne_eq3_21"
label var group3_21 "Gruppen: Einkommen nach hne_eq10_21"

* Anzeige der Gruppen mit Beschriftungen
tab group1_21 group2_21, m
tab group1_21 group3_21, m
fre group1_21 group2_21 group3_21

* Reduzieren auf nötigte Variablen
* drop dsm related variables
keep intj dg_bund rg_bundn stadt_bl int_art ges* alt* help* gewicht_hne hne* trinkgruppe *gr vx2* bier* wein* spir* mish* binge*

save "...\esa21_alc.dta", replace
